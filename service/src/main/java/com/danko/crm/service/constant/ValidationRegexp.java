...
public final class ValidationRegexp {
    ...
    public static final String EMPLOYEE_COMMENT_REGEXP = "^[a-zA-ZА-Яа-я0-9\\s]{0,255}$";
    ...
    public static final String LTD_BANK_REQUISITES_REGEXP = "^[a-zA-ZА-Яа-я0-9,.:;!?\\s-]{1,500}$";

    public static final String LTD_CONTRACT_NUMBER_REGEXP = "^[a-zA-ZА-Яа-я0-9,.:;!?\\s-]{1,100}$";
    public static final String LTD_CONTRACT_OTHER_REGEXP = "^[a-zA-ZА-Яа-я0-9,.:;!?\\s-]{1,255}$";

    public static final String LTD_NAME_FULL_REGEXP = "^[a-zA-ZА-Яа-я0-9,.:;!?\\s-\"]{1,255}$";
    public static final String LTD_NAME_SHORT_REGEXP = "^[a-zA-ZА-Яа-я0-9,.:;!?\\s-\"]{1,255}$";
    public static final String LTD_ADDRESS_REGEXP = "^[a-zA-ZА-Яа-я0-9,.:;!?\\s-\"]{1,255}$";
    public static final String LTD_UNP_REGEXP = "^[a-zA-ZА-Яа-я0-9.:\\s-]{1,45}$";
    ...
    public static final String LTD_INSTANCE_OTHERS_REGEXP = "^[a-zA-ZА-Яа-я0-9,.:;!?\\s-\"]{1,255}$";
    public static final String LTD_INSTANCE_ADDRESS_REGEXP = "^[a-zA-ZА-Яа-я0-9,.:;!?\\s-\"]{1,255}$";
